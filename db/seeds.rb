...
Categorie.create([
  {name: "Roll and Movie", desc: "Rolling dice, spinning a wheel or drawing cards are what allow the players to make their move. Clue, Monopoly, Candyland, and The Game of Life are some 'classic' examples of these games."},
  {name: "Worker Placement", desc: "Worker placement games are usually played slower and with more strategy. Players allocate a limited number of tokens ('workers') to multiple stations that provide various defined actions. Examples of these games are: Viticulture, Dinosaur Island, Lords of Waterdeep, Champions of Midgard, & Rajas of the Ganges"},
  {name: "Cooperative", desc: "Its all about team work. Players work together to acheve a comeon goal, wining the game. Examples of these games are: Pandamic, Castle Panic, and Forbidden Island"},
  {name: "Secret Identity", desc: "Desception is the name of the game. Forgeting who you are and taking in your game character as yourself. Examples of these games are: Mafia, Coup, Secret Hitler, and One Night Ultimate Werewolf. "},
])